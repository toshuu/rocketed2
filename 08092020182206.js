var chat = new Chat({
        ...
        '<img style="width:100%;" src="http://www.azquotes.com/picture-quotes/quote-teacher-who-make-physics-boring-are-criminals-walter-lewin-93-77-02.jpg" />',
		'Hello , <b><span "display:inline" id="displayname"></span></b>... Surely physics is one of the best subjects you will ever learn.' , 'As mentioned, lots of teacher makes it boring for students.','So today we will try to introduce you to concepts of physics without you getting bored .',
          ...
          '<div class="holder"> <div class="bar2"><p style="font-size:12px;font-family: Montserrat, sans-serif;margin-left:28px;margin-top:8px;color:black">What is Physics?</p></div><iframe class="disableRightClick" width="100%" height="400" src="https://www.youtube-nocookie.com/embed/yWMKYID5fr8?rel=0&amp&start=0&end=203" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe></div> ',
		  ...
		  '<img style="width:100%;" src="https://www.tutorialspoint.com/physics_part1/images/force.jpg" />',
          ...
          'There can be many forces, but there are four <b>fundamental forces.</b>' , 
		   ...
		   '<img style="width:100%;" src="http://en.es-static.us/upl/2016/08/Four_Forces-e1471344564203.jpg" />',
		...
		'<img style="width:100%;" src="https://image.slidesharecdn.com/the5thforce-150722051052-lva1-app6892/95/sk-the-5th-force-3-638.jpg?cb=1437554572" />',
	...
	'<img style="width:100%;" src="https://img.purch.com/rc/300x200/aHR0cDovL3d3dy5zcGFjZS5jb20vaW1hZ2VzL2kvMDAwLzA1Ny81Njcvb3JpZ2luYWwvc3BpcmFsLWdhbGF4eS1kYXJrLW1hdHRlci5qcGc=" />',
	'Physicist at Hungarian Academy has found "protophobic X boson" — a strange particle whose existence could indicate a fifth force of nature.',
        ...
        wtypes: [
		 ...
		 'It has many branches such as Mechanics, Electromagnetism, Thermodynamics, Modem Physics, etc. Between 1600 and 1900, three broad areas were developed,which is together called Classical Physics',
		  ...
		  'But by 1905 it became apparent that classical ideas failed to explain several phenomena. ',
		    ...
		    '<img style="width:100%;" src="https://files.askiitians.com/cdn1/images/2017812-183547733-8519-classification-in-physics.jpg" />',
       ...
       cquiz1: [
          ...
          '<img style="width:100%;" src="http://www.aribertmunzner.com/media/photologue/photos/cache/Micro-macro-17_display.jpg" />',
       ...
       whatsthediff: [
          ...
          '<img style="width:100%;" src="http://www.ucl.ac.uk/ioe/courses/images/pgce-physics-with-mathematics" />' , 
		 ...
		 '<img style="width:100%;" src="https://media3.giphy.com/media/yq5CgwSvwhquY/giphy.gif" />' , 
          ...
          ' Invention of X-rays developed the field of diagnosis.',
		   '<img style="width:100%;" src="https://www.radiologyinfo.org/gallery-items/images/bone-xray-hands.jpg" />' , 
		 
		  'Electron and optical microscopic designs have revolutionised the study of medical science',
          '<img style="width:100%;" src="https://micro.magnet.fsu.edu/optics/intelplay/images/intelplay.jpg" />' , 
          ...
          '<img style="width:100%;" src="https://physics.uiowa.edu/sites/physics.uiowa.edu/files/field/image/gallery/alignment_over_veritas_0.jpg" />' , 
		 ...
		 '<img style="width:100%;" src="https://qph.fs.quoracdn.net/main-qimg-90700a6706a186f277d5c8a262e21e91-c" />' , 
		 'Keep your interests in physics and it will inspire your soul to live, <b>for a purpose.</b> !',
		  ...
		  soundsbetter: [
          'You are welcome.',
		  '<img style="width:100%;" src="https://media2.giphy.com/media/X6hiFJjvTDAAw/giphy.gif" />' , 
